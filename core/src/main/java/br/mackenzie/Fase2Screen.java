...
public class Fase2Screen extends FaseBaseScreen{
    ...
    public void show() {
        ...
        // Som 
        patoSound = Gdx.audio.newSound(Gdx.files.internal("Sons_Fase2/PatoQuack.mp3"));
        shieldSound = Gdx.audio.newSound(Gdx.files.internal("Sons_Fase2/ShieldActivate.mp3"));
        damageSound = Gdx.audio.newSound(Gdx.files.internal("Sons_Fase2/damage.mp3"));
        gameOverSound = Gdx.audio.newSound(Gdx.files.internal("Sons_Fase2/game-over.mp3"));
        vitoriaSound = Gdx.audio.newSound(Gdx.files.internal("Sons_Fase2/game-victory.mp3"));
        torcidaSound = Gdx.audio.newSound(Gdx.files.internal("Sons_Fase2/SomTorcida.mp3"));
        // Pause
        ...
        fundoChegadaTexture = new Texture("Imagens_Fase2/Fundo_fase1_chegada.png");
